...
const Benefits = () => {
  ...
  return (
    <div
      className="py-[50px] md:py-[80px] bg-[#f6f6f6]"
      style={{
        backgroundAttachment: "fixed",
        backgroundImage:
          "url('https://i.postimg.cc/gkfhpxG9/pexels-karolina-grabowska-5207015.jpg')",
    ...
    >
      <Container>
        <h1 className="text-[30px] md:text-[50px] text-center font-bold text-main-dark-green p-2 bg-main-green">
          ফাস্ট এইড বক্সটি কিনলে আরো যে সুবিধা গুলো পাবেন
        </h1>
        <div className="flex flex-col md:flex-row gap-y-5 md:gap-x-5 items-center mt-5 md:mt-10">
          <div className="w-full ">
            <ul className="flex flex-col gap-y-5">
              {audienceData.map((item) => (
                <li className="text-[20px] md:text-[30px] bg-[#26773ecc] text-white border-main-green border-[5px] p-4 rounded-lg font-bold flex items-center gap-x-2">
                  {item}
                </li>
              ))}
            </ul>
